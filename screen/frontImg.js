...
const shop_id = await this.props.navigation.getParam('outletcodee');
...
<Text style={{fontSize:18}}>Click Installation Picture</Text>
  </View>
...
{/* </TouchableOpacity> */}
     ...
     <TouchableOpacity  onPress={()=>this.props.navigation.navigate('BrandingInstallScreen') }
