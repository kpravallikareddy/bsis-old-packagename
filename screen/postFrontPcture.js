...
if(this.state.markResult==""){
  ...
  this.setState({isLoader:false})
    ...
    formData.append("postfront_image",  {
      uri: this.state.markResult,
      type: 'image/jpeg',
      name: 'image.jpg',
    });
    console.log('}}}}}}}}',project_id,process_id,shop_id,this.state.markResult)
    axios.post(`https://www.brandspring.in/BSIS/api/save-postfront-image/${userid}`, 
      formData, {
      headers: {
...
<Text style={{fontSize:18}}>Click Post Front Picture</Text>
  </View>
...
<TouchableOpacity onPress={()=>this.onShow()}>
    <Image source={require('../assets/images/addpic.png')}  style={{width:(width/3),height :height/7}}/>
     ...
     <TouchableOpacity  onPress={()=>this.props.navigation.navigate('PreFrontPicture') }
